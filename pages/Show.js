...
export default class Show extends Component {
    constructor(props){
        ...
        this.state={
            mainData:[
                {url:require('../assets/images/demo1.jpg'),info:'每到夏季就会让我们不由自主的去选择白色的服装，因为白色不仅好看，也是最不吸热的颜色。我们也为了找寻这样的答案而寻找出了十位时尚'},
                {url:require('../assets/images/demo2.jpg'),info:'每到夏季就会让我们不由自主的去选择白色的服装，因为白色不仅好看，也是最不吸热的颜色。我们也为了找寻这样的答案而寻找出了十位时尚'},
                {url:require('../assets/images/demo3.jpg'),info:'每到夏季就会让我们不由自主的去选择白色的服装，因为白色不仅好看，也是最不吸热的颜色。我们也为了找寻这样的答案而寻找出了十位时尚'},
            ],
            shareData:[
            ...
            recommendData: [
                {url:require('../assets/images/demo4.jpg'),orderName: '时尚芭莎', title: '卡通人物客串super modal 这样很disney', eyes: '267', msgs: '78'},
                {url:require('../assets/images/demo5.jpg'),orderName: '男人装', title: '除了小白裙，你还可以这样穿这些白色过夏天', eyes: '342', msgs: '261'},
            ],
            commentData:[
                {name:'张小二',url:require('../assets/images/demo1.jpg'),time:'刚刚',like:331,msg:21,info:'天啊撸，为什么这套真丝“睡袍”套装穿她身上会这么仙美 贵族气！蓝色和桃粉色玫瑰印花飘散着甜美气息。1',
                    commentData:[
                        {name1:'一点咨询网友',info:'这里都是游戏暗卫的名字还剩多少钱十年间耗时间节省时间。'},
                        {name1:'张小二',name2:'一点咨询网友',info:'这里都是游戏暗卫的名字还剩多少钱十年间耗时间节省时间。'},
                    ]
                },
                {name:'张小二',url:require('../assets/images/demo2.jpg'),time:'一小时前',like:321,msg:313,info:'天啊撸，为什么这套真丝“睡袍”套装穿她身上会这么仙美 贵族气！蓝色和桃粉色玫瑰印花飘散着甜美气息。2',
                    commentData:[
                        {name1:'zw9love',info:'这里都是游戏暗卫的名字还剩多少钱十年间耗时间节省时间。'},
                        {name1:'青衫衣旧',name2:'一点咨询网友',info:'这里都是游戏暗卫的名字还剩多少钱十年间耗时间节省时间。'},
                    ]
                },
                {name:'张小二',url:require('../assets/images/demo3.jpg'),time:'两小时前',like:311,msg:121,info:'天啊撸，为什么这套真丝“睡袍”套装穿她身上会这么仙美 贵族气！蓝色和桃粉色玫瑰印花飘散着甜美气息。3',commentData:[]},
                {name:'张小二',url:require('../assets/images/demo4.jpg'),time:'三小时前',like:321,msg:565,info:'天啊撸，为什么这套真丝“睡袍”套装穿她身上会这么仙美 贵族气！蓝色和桃粉色玫瑰印花飘散着甜美气息。4',commentData:[]},
                {name:'张小二',url:require('../assets/images/demo5.jpg'),time:'六小时前',like:654,msg:321,info:'天啊撸，为什么这套真丝“睡袍”套装穿她身上会这么仙美 贵族气！蓝色和桃粉色玫瑰印花飘散着甜美气息。5',commentData:[]},
            ],
            bottomShareData:[
    ...
    renderShareMainCell(){
        ...
        data.map((msg,i)=>{
            arr.push(
                <TouchableOpacity key={i} style={{alignItems: 'center',marginTop:10,marginBottom:10,marginLeft:marginBottomShareLeft}}>
    ...
    star(){
        ...
        this.lock = true
        if(this.count % 2){
            this.setState({starHoverActive:true,modalTxt:'已收藏',starImage:require('../assets/images/star_hover.png')})
