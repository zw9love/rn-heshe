                ...
                if(msg.name2){
                    ...
                    arr.push(
                        <View key={i} style={styles.commentCellWrap}>
                            <TouchableOpacity onPress={()=>{this.getInfoName(name1)}}>
                                <Text>
                                    <Text style={styles.nameStyle} onPress={()=>{this.getInfoName(name1)}}>
                                        {name1}
                                    </Text>
                                    <Text style={[styles.otherStyle,{marginLeft:5,marginRight:5}]}>
                                        回复
                                    </Text>
                                    <Text style={styles.nameStyle} onPress={()=>{this.getInfoName(name2)}}>
                                        {name2}：
                                    </Text>
                    ...
                    arr.push(
                        <View key={i} style={styles.commentCellWrap}>
                            <TouchableOpacity onPress={()=>{this.getInfoName(msg.name1)}}>
                                <Text>
                        ...
                        <View style={styles.infoTopWrap_right}>
                            <View style={[styles.dataWrap,{marginRight:20}]}>
                                ...
                                <TouchableOpacity onPress={this.myLike}>
                                    <Image source={require('../assets/images/like.png')} style={{width:15,height:16}}/>
                                </TouchableOpacity>
                            </View>
                            <View style={styles.dataWrap}>
                                <Text style={{marginRight:5,fontSize:12}}>{this.props.data.msg}</Text>
                                <TouchableOpacity onPress={()=>{this.myEditMsg(this.props.index)}}>
                                    <Image source={require('../assets/images/fix_msg.png')} style={{width:16,height:16}}/>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
